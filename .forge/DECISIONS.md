...
- The next dependency-closed slice is `repair agent handoff`.
- Goal: keep the new structured repair plan plus claimable repair work-item surface, then move actual execution from controller-owned claims to an explicit repair agent / repair lane worker.
