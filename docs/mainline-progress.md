...
- 当前真正缺的是“把这条 dispatch 继续接到独立 repair agent / repair lane worker，而不是由当前 controller 自己完成执行”。
...
- 把 repair dispatch 从当前 controller-owned execution 继续推进到独立 repair agent / repair lane worker
